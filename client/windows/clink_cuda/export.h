 ...
 * ::cudaGetErrorString
 */
__declspec(dllexport) CUresult CUDAAPI cuGetErrorString(CUresult error, const char **pStr);
 ...
 * ::cudaGetErrorName
 */
__declspec(dllexport) CUresult CUDAAPI cuGetErrorName(CUresult error, const char **pStr);
 ...
 * \notefnerr
 */
__declspec(dllexport) CUresult CUDAAPI cuInit(unsigned int Flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDriverGetVersion(int *driverVersion);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGet(CUdevice *device, int ordinal);
 ...
 * ::cudaGetDeviceCount
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetCount(int *count);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetName(char *name, int len, CUdevice dev);
 ...
 * ::cudaGetDeviceProperties
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetUuid(CUuuid *uuid, CUdevice dev);
 ...
 * ::cudaGetDeviceProperties
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetUuid_v2(CUuuid *uuid, CUdevice dev);
 ...
 * ::cudaGetDeviceProperties
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetLuid(char *luid, unsigned int *deviceNodeMask, CUdevice dev);
 ...
 * ::cudaMemGetInfo
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceTotalMem(size_t *bytes, CUdevice dev);
 ...
 * ::cuDeviceTotalMem
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetTexture1DLinearMaxWidth(size_t *maxWidthInElements, CUarray_format format, unsigned numChannels, CUdevice dev);
 ...
 * ::cudaGetDeviceProperties
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetAttribute(int *pi, CUdevice_attribute attrib, CUdevice dev);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetNvSciSyncAttributes(void *nvSciSyncAttrList, CUdevice dev, int flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceSetMemPool(CUdevice dev, CUmemoryPool pool);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetMemPool(CUmemoryPool *pool, CUdevice dev);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetDefaultMemPool(CUmemoryPool *pool_out, CUdevice dev);
 ...
 * ::cuDeviceTotalMem
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetExecAffinitySupport(int *pi, CUexecAffinityType type, CUdevice dev);
 ...
 *
 */
__declspec(dllexport) CUresult CUDAAPI cuFlushGPUDirectRDMAWrites(CUflushGPUDirectRDMAWritesTarget target, CUflushGPUDirectRDMAWritesScope scope);
 ...
 * ::cuDeviceTotalMem
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuDeviceGetProperties(CUdevprop *prop, CUdevice dev);
 ...
 * ::cuDeviceTotalMem
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuDeviceComputeCapability(int *major, int *minor, CUdevice dev);
 ...
 * ::cuCtxSynchronize
 */
__declspec(dllexport) CUresult CUDAAPI cuDevicePrimaryCtxRetain(CUcontext *pctx, CUdevice dev);
 ...
 * ::cuCtxSynchronize
 */
__declspec(dllexport) CUresult CUDAAPI cuDevicePrimaryCtxRelease(CUdevice dev);
 ...
 * ::cudaSetDeviceFlags
 */
__declspec(dllexport) CUresult CUDAAPI cuDevicePrimaryCtxSetFlags(CUdevice dev, unsigned int flags);
 ...
 * ::cudaGetDeviceFlags
 */
__declspec(dllexport) CUresult CUDAAPI cuDevicePrimaryCtxGetState(CUdevice dev, unsigned int *flags, int *active);
 ...
 * ::cudaDeviceReset
 */
__declspec(dllexport) CUresult CUDAAPI cuDevicePrimaryCtxReset(CUdevice dev);
 ...
 * ::cuCtxSynchronize
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxCreate(CUcontext *pctx, unsigned int flags, CUdevice dev);
 ...
 * ::CUexecAffinityParam
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxCreate_v3(CUcontext *pctx, CUexecAffinityParam *paramsArray, int numParams, unsigned int flags, CUdevice dev);
 ...
 * ::cuCtxSynchronize
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxDestroy(CUcontext ctx);
 ...
 * ::cuCtxSynchronize
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxPushCurrent(CUcontext ctx);
 ...
 * ::cuCtxSynchronize
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxPopCurrent(CUcontext *pctx);
 ...
 * ::cudaSetDevice
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxSetCurrent(CUcontext ctx);
 ...
 * ::cudaGetDevice
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxGetCurrent(CUcontext *pctx);
 ...
 * ::cudaGetDevice
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxGetDevice(CUdevice *device);
 ...
 * ::cudaGetDeviceFlags
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxGetFlags(unsigned int *flags);
 ...
 * ::cuDevicePrimaryCtxSetFlags,
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxSetFlags(unsigned int flags);
 ...
 * ::cuCtxPushCurrent
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxGetId(CUcontext ctx, unsigned long long *ctxId);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxSynchronize(void);
 ...
 * ::cudaDeviceSetLimit
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxSetLimit(CUlimit limit, size_t value);
 ...
 * ::cudaDeviceGetLimit
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxGetLimit(size_t *pvalue, CUlimit limit);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxGetCacheConfig(CUfunc_cache *pconfig);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxSetCacheConfig(CUfunc_cache config);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxGetSharedMemConfig(CUsharedconfig *pConfig);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxSetSharedMemConfig(CUsharedconfig config);
 ...
 * ::cuCtxSynchronize
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxGetApiVersion(CUcontext ctx, unsigned int *version);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxGetStreamPriorityRange(int *leastPriority, int *greatestPriority);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxResetPersistingL2Cache(void);
 ...
 * ::CUexecAffinityParam
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxGetExecAffinity(CUexecAffinityParam *pExecAffinity, CUexecAffinityType type);
 ...
 * ::cuCtxSynchronize
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuCtxAttach(CUcontext *pctx, unsigned int flags);
 ...
 * ::cuCtxSynchronize
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuCtxDetach(CUcontext ctx);
 ...
 * ::cuModuleUnload
 */
__declspec(dllexport) CUresult CUDAAPI cuModuleLoad(CUmodule *module, const char *fname);
 ...
 * ::cuModuleUnload
 */
__declspec(dllexport) CUresult CUDAAPI cuModuleLoadData(CUmodule *module, const void *image);
 ...
 * ::cuModuleUnload
 */
__declspec(dllexport) CUresult CUDAAPI cuModuleLoadDataEx(CUmodule *module, const void *image, unsigned int numOptions, CUjit_option *options, void **optionValues);
 ...
 * ::cuModuleUnload
 */
__declspec(dllexport) CUresult CUDAAPI cuModuleLoadFatBinary(CUmodule *module, const void *fatCubin);
 ...
 * ::cuModuleLoadFatBinary
 */
__declspec(dllexport) CUresult CUDAAPI cuModuleUnload(CUmodule hmod);
 ...
 * ::cuModuleLoad,
 */
__declspec(dllexport) CUresult CUDAAPI cuModuleGetLoadingMode(CUmoduleLoadingMode *mode);
 ...
 * ::cuModuleUnload
 */
__declspec(dllexport) CUresult CUDAAPI cuModuleGetFunction(CUfunction *hfunc, CUmodule hmod, const char *name);
 ...
 * ::cudaGetSymbolSize
 */
__declspec(dllexport) CUresult CUDAAPI cuModuleGetGlobal(CUdeviceptr *dptr, size_t *bytes, CUmodule hmod, const char *name);
 ...
 * ::cuLinkDestroy
 */
__declspec(dllexport) CUresult CUDAAPI
 ...
 * ::cuModuleUnload
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuModuleGetTexRef(CUtexref *pTexRef, CUmodule hmod, const char *name);
 ...
 * ::cuModuleUnload
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuModuleGetSurfRef(CUsurfref *pSurfRef, CUmodule hmod, const char *name);
 ...
 * ::cuModuleLoadDataEx
 */
__declspec(dllexport) CUresult CUDAAPI cuLibraryLoadData(CUlibrary *library, const void *code,
 ...
 * ::cuModuleLoadDataEx
 */
__declspec(dllexport) CUresult CUDAAPI cuLibraryLoadFromFile(CUlibrary *library, const char *fileName,
                                       CUjit_option *jitOptions, void **jitOptionsValues, unsigned int numJitOptions,
                                       CUlibraryOption *libraryOptions, void **libraryOptionValues, unsigned int numLibraryOptions);
 ...
 * ::cuModuleUnload
 */
__declspec(dllexport) CUresult CUDAAPI cuLibraryUnload(CUlibrary library);
 ...
 * ::cuModuleGetFunction
 */
__declspec(dllexport) CUresult CUDAAPI cuLibraryGetKernel(CUkernel *pKernel, CUlibrary library, const char *name);
 ...
 * ::cuModuleGetFunction
 */
__declspec(dllexport) CUresult CUDAAPI cuLibraryGetModule(CUmodule *pMod, CUlibrary library);
 ...
 * ::cuModuleGetFunction
 */
__declspec(dllexport) CUresult CUDAAPI cuKernelGetFunction(CUfunction *pFunc, CUkernel kernel);
 ...
 * cuModuleGetGlobal
 */
__declspec(dllexport) CUresult CUDAAPI cuLibraryGetGlobal(CUdeviceptr *dptr, size_t *bytes, CUlibrary library, const char *name);
 ...
 * ::cuLibraryUnload,
 */
__declspec(dllexport) CUresult CUDAAPI cuLibraryGetManaged(CUdeviceptr *dptr, size_t *bytes, CUlibrary library, const char *name);
 ...
 * ::cuLibraryUnload,
 */
__declspec(dllexport) CUresult CUDAAPI cuLibraryGetUnifiedFunction(void **fptr, CUlibrary library, const char *symbol);
 ...
 * ::cuFuncGetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuKernelGetAttribute(int *pi, CUfunction_attribute attrib, CUkernel kernel, CUdevice dev);
 ...
 * ::cuFuncSetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuKernelSetAttribute(CUfunction_attribute attrib, int val, CUkernel kernel, CUdevice dev);
 ...
 * ::cuLaunchKernel
 */
__declspec(dllexport) CUresult CUDAAPI cuKernelSetCacheConfig(CUkernel kernel, CUfunc_cache config, CUdevice dev);
 ...
 * ::cudaMemGetInfo
 */
__declspec(dllexport) CUresult CUDAAPI cuMemGetInfo(size_t *free, size_t *total);
 ...
 * ::cudaMalloc
 */
__declspec(dllexport) CUresult CUDAAPI cuMemAlloc(CUdeviceptr *dptr, size_t bytesize);
 ...
 * ::cudaMallocPitch
 */
__declspec(dllexport) CUresult CUDAAPI cuMemAllocPitch(CUdeviceptr *dptr, size_t *pPitch, size_t WidthInBytes, size_t Height, unsigned int ElementSizeBytes);
 ...
 * ::cudaFree
 */
__declspec(dllexport) CUresult CUDAAPI cuMemFree(CUdeviceptr dptr);
 ...
 * ::cuMemsetD2D32, ::cuMemsetD8, ::cuMemsetD16, ::cuMemsetD32
 */
__declspec(dllexport) CUresult CUDAAPI cuMemGetAddressRange(CUdeviceptr *pbase, size_t *psize, CUdeviceptr dptr);
 ...
 * ::cudaMallocHost
 */
__declspec(dllexport) CUresult CUDAAPI cuMemAllocHost(void **pp, size_t bytesize);
 ...
 * ::cudaFreeHost
 */
__declspec(dllexport) CUresult CUDAAPI cuMemFreeHost(void *p);
 ...
 * ::cudaHostAlloc
 */
__declspec(dllexport) CUresult CUDAAPI cuMemHostAlloc(void **pp, size_t bytesize, unsigned int Flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemHostGetDevicePointer(CUdeviceptr *pdptr, void *p, unsigned int Flags);
 ...
 * ::cudaHostGetFlags
 */
__declspec(dllexport) CUresult CUDAAPI cuMemHostGetFlags(unsigned int *pFlags, void *p);
 ...
 * ::cudaMallocManaged
 */
__declspec(dllexport) CUresult CUDAAPI cuMemAllocManaged(CUdeviceptr *dptr, size_t bytesize, unsigned int flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetByPCIBusId(CUdevice *dev, const char *pciBusId);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetPCIBusId(char *pciBusId, int len, CUdevice dev);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuIpcGetEventHandle(CUipcEventHandle *pHandle, CUevent event);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuIpcOpenEventHandle(CUevent *phEvent, CUipcEventHandle handle);
 ...
 * ::cudaIpcGetMemHandle
 */
__declspec(dllexport) CUresult CUDAAPI cuIpcGetMemHandle(CUipcMemHandle *pHandle, CUdeviceptr dptr);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuIpcOpenMemHandle(CUdeviceptr *pdptr, CUipcMemHandle handle, unsigned int Flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuIpcCloseMemHandle(CUdeviceptr dptr);
 ...
 * ::cudaHostRegister
 */
__declspec(dllexport) CUresult CUDAAPI cuMemHostRegister(void *p, size_t bytesize, unsigned int Flags);
 ...
 * ::cudaHostUnregister
 */
__declspec(dllexport) CUresult CUDAAPI cuMemHostUnregister(void *p);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpy(CUdeviceptr dst, CUdeviceptr src, size_t ByteCount);
 ...
 * ::cudaMemcpyPeer
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyPeer(CUdeviceptr dstDevice, CUcontext dstContext, CUdeviceptr srcDevice, CUcontext srcContext, size_t ByteCount);
 ...
 * ::cudaMemcpyToSymbol
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyHtoD(CUdeviceptr dstDevice, const void *srcHost, size_t ByteCount);
 ...
 * ::cudaMemcpyFromSymbol
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyDtoH(void *dstHost, CUdeviceptr srcDevice, size_t ByteCount);
 ...
 * ::cudaMemcpyFromSymbol
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyDtoD(CUdeviceptr dstDevice, CUdeviceptr srcDevice, size_t ByteCount);
 ...
 * ::cudaMemcpyToArray
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyDtoA(CUarray dstArray, size_t dstOffset, CUdeviceptr srcDevice, size_t ByteCount);
 ...
 * ::cudaMemcpyFromArray
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyAtoD(CUdeviceptr dstDevice, CUarray srcArray, size_t srcOffset, size_t ByteCount);
 ...
 * ::cudaMemcpyToArray
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyHtoA(CUarray dstArray, size_t dstOffset, const void *srcHost, size_t ByteCount);
 ...
 * ::cudaMemcpyFromArray
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyAtoH(void *dstHost, CUarray srcArray, size_t srcOffset, size_t ByteCount);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyAtoA(CUarray dstArray, size_t dstOffset, CUarray srcArray, size_t srcOffset, size_t ByteCount);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpy2D(const CUDA_MEMCPY2D *pCopy);
 ...
 * ::cudaMemcpy2DFromArray
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpy2DUnaligned(const CUDA_MEMCPY2D *pCopy);
 ...
 * ::cudaMemcpy3D
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpy3D(const CUDA_MEMCPY3D *pCopy);
 ...
 * ::cudaMemcpy3DPeer
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpy3DPeer(const CUDA_MEMCPY3D_PEER *pCopy);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyAsync(CUdeviceptr dst, CUdeviceptr src, size_t ByteCount, CUstream hStream);
 ...
 * ::cudaMemcpyPeerAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyPeerAsync(CUdeviceptr dstDevice, CUcontext dstContext, CUdeviceptr srcDevice, CUcontext srcContext, size_t ByteCount, CUstream hStream);
 ...
 * ::cudaMemcpyToSymbolAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyHtoDAsync(CUdeviceptr dstDevice, const void *srcHost, size_t ByteCount, CUstream hStream);
 ...
 * ::cudaMemcpyFromSymbolAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyDtoHAsync(void *dstHost, CUdeviceptr srcDevice, size_t ByteCount, CUstream hStream);
 ...
 * ::cudaMemcpyFromSymbolAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyDtoDAsync(CUdeviceptr dstDevice, CUdeviceptr srcDevice, size_t ByteCount, CUstream hStream);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyHtoAAsync(CUarray dstArray, size_t dstOffset, const void *srcHost, size_t ByteCount, CUstream hStream);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpyAtoHAsync(void *dstHost, CUarray srcArray, size_t srcOffset, size_t ByteCount, CUstream hStream);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpy2DAsync(const CUDA_MEMCPY2D *pCopy, CUstream hStream);
 ...
 * ::cudaMemcpy3DAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpy3DAsync(const CUDA_MEMCPY3D *pCopy, CUstream hStream);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemcpy3DPeerAsync(const CUDA_MEMCPY3D_PEER *pCopy, CUstream hStream);
 ...
 * ::cudaMemset
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD8(CUdeviceptr dstDevice, unsigned char uc, size_t N);
 ...
 * ::cudaMemset
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD16(CUdeviceptr dstDevice, unsigned short us, size_t N);
 ...
 * ::cudaMemset
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD32(CUdeviceptr dstDevice, unsigned int ui, size_t N);
 ...
 * ::cudaMemset2D
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD2D8(CUdeviceptr dstDevice, size_t dstPitch, unsigned char uc, size_t Width, size_t Height);
 ...
 * ::cudaMemset2D
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD2D16(CUdeviceptr dstDevice, size_t dstPitch, unsigned short us, size_t Width, size_t Height);
 ...
 * ::cudaMemset2D
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD2D32(CUdeviceptr dstDevice, size_t dstPitch, unsigned int ui, size_t Width, size_t Height);
 ...
 * ::cudaMemsetAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD8Async(CUdeviceptr dstDevice, unsigned char uc, size_t N, CUstream hStream);
 ...
 * ::cudaMemsetAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD16Async(CUdeviceptr dstDevice, unsigned short us, size_t N, CUstream hStream);
 ...
 * ::cudaMemsetAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD32Async(CUdeviceptr dstDevice, unsigned int ui, size_t N, CUstream hStream);
 ...
 * ::cudaMemset2DAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD2D8Async(CUdeviceptr dstDevice, size_t dstPitch, unsigned char uc, size_t Width, size_t Height, CUstream hStream);
 ...
 * ::cudaMemset2DAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD2D16Async(CUdeviceptr dstDevice, size_t dstPitch, unsigned short us, size_t Width, size_t Height, CUstream hStream);
 ...
 * ::cudaMemset2DAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuMemsetD2D32Async(CUdeviceptr dstDevice, size_t dstPitch, unsigned int ui, size_t Width, size_t Height, CUstream hStream);
 ...
 * ::cudaMallocArray
 */
__declspec(dllexport) CUresult CUDAAPI cuArrayCreate(CUarray *pHandle, const CUDA_ARRAY_DESCRIPTOR *pAllocateArray);
 ...
 * ::cudaArrayGetInfo
 */
__declspec(dllexport) CUresult CUDAAPI cuArrayGetDescriptor(CUDA_ARRAY_DESCRIPTOR *pArrayDescriptor, CUarray hArray);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuArrayGetSparseProperties(CUDA_ARRAY_SPARSE_PROPERTIES *sparseProperties, CUarray array);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMipmappedArrayGetSparseProperties(CUDA_ARRAY_SPARSE_PROPERTIES *sparseProperties, CUmipmappedArray mipmap);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuArrayGetMemoryRequirements(CUDA_ARRAY_MEMORY_REQUIREMENTS *memoryRequirements, CUarray array, CUdevice device);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMipmappedArrayGetMemoryRequirements(CUDA_ARRAY_MEMORY_REQUIREMENTS *memoryRequirements, CUmipmappedArray mipmap, CUdevice device);
 ...
 * ::cudaArrayGetPlane
 */
__declspec(dllexport) CUresult CUDAAPI cuArrayGetPlane(CUarray *pPlaneArray, CUarray hArray, unsigned int planeIdx);
 ...
 * ::cudaFreeArray
 */
__declspec(dllexport) CUresult CUDAAPI cuArrayDestroy(CUarray hArray);
 ...
 * ::cudaMalloc3DArray
 */
__declspec(dllexport) CUresult CUDAAPI cuArray3DCreate(CUarray *pHandle, const CUDA_ARRAY3D_DESCRIPTOR *pAllocateArray);
 ...
 * ::cudaArrayGetInfo
 */
__declspec(dllexport) CUresult CUDAAPI cuArray3DGetDescriptor(CUDA_ARRAY3D_DESCRIPTOR *pArrayDescriptor, CUarray hArray);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMipmappedArrayCreate(CUmipmappedArray *pHandle, const CUDA_ARRAY3D_DESCRIPTOR *pMipmappedArrayDesc, unsigned int numMipmapLevels);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMipmappedArrayGetLevel(CUarray *pLevelArray, CUmipmappedArray hMipmappedArray, unsigned int level);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMipmappedArrayDestroy(CUmipmappedArray hMipmappedArray);
...
* CUDA_ERROR_NOT_SUPPORTED 
*/
__declspec(dllexport) CUresult CUDAAPI cuMemGetHandleForAddressRange(void *handle, CUdeviceptr dptr, size_t size, CUmemRangeHandleType handleType, unsigned long long flags);
...
* \sa ::cuMemAddressFree
*/
__declspec(dllexport) CUresult CUDAAPI cuMemAddressReserve(CUdeviceptr *ptr, size_t size, size_t alignment, CUdeviceptr addr, unsigned long long flags);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMemAddressFree(CUdeviceptr ptr, size_t size);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMemCreate(CUmemGenericAllocationHandle *handle, size_t size, const CUmemAllocationProp *prop, unsigned long long flags);
...
* \sa ::cuMemCreate
*/
__declspec(dllexport) CUresult CUDAAPI cuMemRelease(CUmemGenericAllocationHandle handle);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMemMap(CUdeviceptr ptr, size_t size, size_t offset, CUmemGenericAllocationHandle handle, unsigned long long flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemMapArrayAsync(CUarrayMapInfo  *mapInfoList, unsigned int count, CUstream hStream);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMemUnmap(CUdeviceptr ptr, size_t size);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMemSetAccess(CUdeviceptr ptr, size_t size, const CUmemAccessDesc *desc, size_t count);
...
* \sa ::cuMemSetAccess
*/
__declspec(dllexport) CUresult CUDAAPI cuMemGetAccess(unsigned long long *flags, const CUmemLocation *location, CUdeviceptr ptr);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMemExportToShareableHandle(void *shareableHandle, CUmemGenericAllocationHandle handle, CUmemAllocationHandleType handleType, unsigned long long flags);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMemImportFromShareableHandle(CUmemGenericAllocationHandle *handle, void *osHandle, CUmemAllocationHandleType shHandleType);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMemGetAllocationGranularity(size_t *granularity, const CUmemAllocationProp *prop, CUmemAllocationGranularity_flags option);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMemGetAllocationPropertiesFromHandle(CUmemAllocationProp *prop, CUmemGenericAllocationHandle handle);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMemRetainAllocationHandle(CUmemGenericAllocationHandle *handle, void *addr);
 ...
 * ::CUDA_ERROR_NOT_SUPPORTED
 */
__declspec(dllexport) CUresult CUDAAPI cuMemFreeAsync(CUdeviceptr dptr, CUstream hStream);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemAllocAsync(CUdeviceptr *dptr, size_t bytesize, CUstream hStream);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolTrimTo(CUmemoryPool pool, size_t minBytesToKeep);
 ...
 *     ::cuDeviceGetMemPool, ::cuMemPoolCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolSetAttribute(CUmemoryPool pool, CUmemPool_attribute attr, void *value);
 ...
 *     ::cuDeviceGetMemPool, ::cuMemPoolCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolGetAttribute(CUmemoryPool pool, CUmemPool_attribute attr, void *value);
 ...
 *     ::cuDeviceGetMemPool, ::cuMemPoolCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolSetAccess(CUmemoryPool pool, const CUmemAccessDesc *map, size_t count);
 ...
 *     ::cuDeviceGetMemPool, ::cuMemPoolCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolGetAccess(CUmemAccess_flags *flags, CUmemoryPool memPool, CUmemLocation *location);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolCreate(CUmemoryPool *pool, const CUmemPoolProps *poolProps);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolDestroy(CUmemoryPool pool);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemAllocFromPoolAsync(CUdeviceptr *dptr, size_t bytesize, CUmemoryPool pool, CUstream hStream);
 ...
 *     ::cuMemPoolSetAccess, ::cuMemPoolSetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolExportToShareableHandle(void *handle_out, CUmemoryPool pool, CUmemAllocationHandleType handleType, unsigned long long flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolImportFromShareableHandle(
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolExportPointer(CUmemPoolPtrExportData *shareData_out, CUdeviceptr ptr);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPoolImportPointer(CUdeviceptr *ptr_out, CUmemoryPool pool, CUmemPoolPtrExportData *shareData);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMulticastCreate(CUmemGenericAllocationHandle *mcHandle, const CUmulticastObjectProp *prop);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMulticastAddDevice(CUmemGenericAllocationHandle mcHandle, CUdevice dev);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMulticastBindMem(CUmemGenericAllocationHandle mcHandle, size_t mcOffset, CUmemGenericAllocationHandle memHandle, size_t memOffset, size_t size, unsigned long long flags);
 ...
 * \sa ::cuMulticastCreate, ::cuMulticastAddDevice, ::cuMemCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuMulticastBindAddr(CUmemGenericAllocationHandle mcHandle, size_t mcOffset, CUdeviceptr memptr, size_t size, unsigned long long flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMulticastUnbind(CUmemGenericAllocationHandle mcHandle, CUdevice dev, size_t mcOffset, size_t size);
...
*/
__declspec(dllexport) CUresult CUDAAPI cuMulticastGetGranularity(size_t *granularity, const CUmulticastObjectProp *prop, CUmulticastGranularity_flags option);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuPointerGetAttribute(void *data, CUpointer_attribute attribute, CUdeviceptr ptr);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemPrefetchAsync(CUdeviceptr devPtr, size_t count, CUdevice dstDevice, CUstream hStream);
 ...
 * ::cudaMemAdvise
 */
__declspec(dllexport) CUresult CUDAAPI cuMemAdvise(CUdeviceptr devPtr, size_t count, CUmem_advise advice, CUdevice device);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemRangeGetAttribute(void *data, size_t dataSize, CUmem_range_attribute attribute, CUdeviceptr devPtr, size_t count);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuMemRangeGetAttributes(void **data, size_t *dataSizes, CUmem_range_attribute *attributes, size_t numAttributes, CUdeviceptr devPtr, size_t count);
 ...
 * ::cuMemHostUnregister
 */
__declspec(dllexport) CUresult CUDAAPI cuPointerSetAttribute(const void *value, CUpointer_attribute attribute, CUdeviceptr ptr);
 ...
 * ::cudaPointerGetAttributes
 */
__declspec(dllexport) CUresult CUDAAPI cuPointerGetAttributes(unsigned int numAttributes, CUpointer_attribute *attributes, void **data, CUdeviceptr ptr);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamCreate(CUstream *phStream, unsigned int Flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamCreateWithPriority(CUstream *phStream, unsigned int flags, int priority);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamGetPriority(CUstream hStream, int *priority);
 ...
 * ::cudaStreamGetFlags
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamGetFlags(CUstream hStream, unsigned int *flags);
 ...
 * ::cudaStreamGetId
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamGetId(CUstream hStream, unsigned long long *streamId);
 ...
 * ::cudaStreamCreateWithFlags
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamGetCtx(CUstream hStream, CUcontext *pctx);
 ...
 * ::cudaStreamWaitEvent
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamWaitEvent(CUstream hStream, CUevent hEvent, unsigned int Flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamAddCallback(CUstream hStream, CUstreamCallback callback, void *userData, unsigned int flags);
 ...
 * ::cuThreadExchangeStreamCaptureMode
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamBeginCapture(CUstream hStream, CUstreamCaptureMode mode);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuThreadExchangeStreamCaptureMode(CUstreamCaptureMode *mode);
 ...
 * ::cuStreamIsCapturing
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamEndCapture(CUstream hStream, CUgraph *phGraph);
 ...
 * ::cuStreamEndCapture
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamIsCapturing(CUstream hStream, CUstreamCaptureStatus *captureStatus);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamGetCaptureInfo(CUstream hStream, CUstreamCaptureStatus *captureStatus_out,
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamUpdateCaptureDependencies(CUstream hStream, CUgraphNode *dependencies, size_t numDependencies, unsigned int flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamAttachMemAsync(CUstream hStream, CUdeviceptr dptr, size_t length, unsigned int flags);
 ...
 * ::cudaStreamQuery
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamQuery(CUstream hStream);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamSynchronize(CUstream hStream);
 ...
 * ::cudaStreamDestroy
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamDestroy(CUstream hStream);
 ...
 * ::CUaccessPolicyWindow
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamCopyAttributes(CUstream dst, CUstream src);
 ...
 * ::CUaccessPolicyWindow
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamGetAttribute(CUstream hStream, CUstreamAttrID attr,
 ...
 * ::CUaccessPolicyWindow
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamSetAttribute(CUstream hStream, CUstreamAttrID attr,
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuEventCreate(CUevent *phEvent, unsigned int Flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuEventRecord(CUevent hEvent, CUstream hStream);
 ...
 * ::cudaEventRecord
 */
__declspec(dllexport) CUresult CUDAAPI cuEventRecordWithFlags(CUevent hEvent, CUstream hStream, unsigned int flags);
 ...
 * ::cudaEventQuery
 */
__declspec(dllexport) CUresult CUDAAPI cuEventQuery(CUevent hEvent);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuEventSynchronize(CUevent hEvent);
 ...
 * ::cudaEventDestroy
 */
__declspec(dllexport) CUresult CUDAAPI cuEventDestroy(CUevent hEvent);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuEventElapsedTime(float *pMilliseconds, CUevent hStart, CUevent hEnd);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuImportExternalMemory(CUexternalMemory *extMem_out, const CUDA_EXTERNAL_MEMORY_HANDLE_DESC *memHandleDesc);
 ...
 * ::cuExternalMemoryGetMappedMipmappedArray
 */
__declspec(dllexport) CUresult CUDAAPI cuExternalMemoryGetMappedBuffer(CUdeviceptr *devPtr, CUexternalMemory extMem, const CUDA_EXTERNAL_MEMORY_BUFFER_DESC *bufferDesc);
 ...
 * ::cuExternalMemoryGetMappedBuffer
 */
__declspec(dllexport) CUresult CUDAAPI cuExternalMemoryGetMappedMipmappedArray(CUmipmappedArray *mipmap, CUexternalMemory extMem, const CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC *mipmapDesc);
 ...
 * ::cuExternalMemoryGetMappedMipmappedArray
 */
__declspec(dllexport) CUresult CUDAAPI cuDestroyExternalMemory(CUexternalMemory extMem);
 ...
 * ::cuWaitExternalSemaphoresAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuImportExternalSemaphore(CUexternalSemaphore *extSem_out, const CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC *semHandleDesc);
 ...
 * ::cuWaitExternalSemaphoresAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuSignalExternalSemaphoresAsync(const CUexternalSemaphore *extSemArray, const CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS *paramsArray, unsigned int numExtSems, CUstream stream);
 ...
 * ::cuSignalExternalSemaphoresAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuWaitExternalSemaphoresAsync(const CUexternalSemaphore *extSemArray, const CUDA_EXTERNAL_SEMAPHORE_WAIT_PARAMS *paramsArray, unsigned int numExtSems, CUstream stream);
 ...
 * ::cuWaitExternalSemaphoresAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuDestroyExternalSemaphore(CUexternalSemaphore extSem);
 ...
 * ::cuStreamWaitEvent
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamWaitValue32(CUstream stream, CUdeviceptr addr, cuuint32_t value, unsigned int flags);
 ...
 * ::cuStreamWaitEvent
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamWaitValue64(CUstream stream, CUdeviceptr addr, cuuint64_t value, unsigned int flags);
 ...
 * ::cuEventRecord
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamWriteValue32(CUstream stream, CUdeviceptr addr, cuuint32_t value, unsigned int flags);
 ...
 * ::cuEventRecord
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamWriteValue64(CUstream stream, CUdeviceptr addr, cuuint64_t value, unsigned int flags);
 ...
 * ::cuMemHostRegister
 */
__declspec(dllexport) CUresult CUDAAPI cuStreamBatchMemOp(CUstream stream, unsigned int count, CUstreamBatchMemOpParams *paramArray, unsigned int flags);
 ...
 * ::cuKernelGetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuFuncGetAttribute(int *pi, CUfunction_attribute attrib, CUfunction hfunc);
 ...
 * ::cuKernelSetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuFuncSetAttribute(CUfunction hfunc, CUfunction_attribute attrib, int value);
 ...
 * ::cuKernelSetCacheConfig
 */
__declspec(dllexport) CUresult CUDAAPI cuFuncSetCacheConfig(CUfunction hfunc, CUfunc_cache config);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuFuncSetSharedMemConfig(CUfunction hfunc, CUsharedconfig config);
 ...
 *
 */
__declspec(dllexport) CUresult CUDAAPI cuFuncGetModule(CUmodule *hmod, CUfunction hfunc);
 ...
 * ::cuKernelSetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuLaunchKernel(CUfunction f,
 ...
 * ::cuKernelSetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuLaunchKernelEx(const CUlaunchConfig *config,
                                  CUfunction f,
                                  void **kernelParams,
                                  void **extra);
 ...
 * ::cuKernelSetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuLaunchCooperativeKernel(CUfunction f,
                                unsigned int gridDimX,
                                unsigned int gridDimY,
                                unsigned int gridDimZ,
                                unsigned int blockDimX,
 ...
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuLaunchCooperativeKernelMultiDevice(CUDA_LAUNCH_PARAMS *launchParamsList, unsigned int numDevices, unsigned int flags);
 ...
 * ::cuStreamAddCallback
 */
__declspec(dllexport) CUresult CUDAAPI cuLaunchHostFunc(CUstream hStream, CUhostFn fn, void *userData);
 ...
 * ::cuLaunchKernel
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuFuncSetBlockShape(CUfunction hfunc, int x, int y, int z);
 ...
 * ::cuLaunchKernel
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuFuncSetSharedSize(CUfunction hfunc, unsigned int bytes);
 ...
 * ::cuLaunchKernel
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuParamSetSize(CUfunction hfunc, unsigned int numbytes);
 ...
 * ::cuLaunchKernel
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuParamSeti(CUfunction hfunc, int offset, unsigned int value);
 ...
 * ::cuLaunchKernel
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuParamSetf(CUfunction hfunc, int offset, float value);
 ...
 * ::cuLaunchKernel
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuParamSetv(CUfunction hfunc, int offset, void *ptr, unsigned int numbytes);
 ...
 * ::cuLaunchKernel
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuLaunch(CUfunction f);
 ...
 * ::cuLaunchKernel
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuLaunchGrid(CUfunction f, int grid_width, int grid_height);
 ...
 * ::cuLaunchKernel
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuLaunchGridAsync(CUfunction f, int grid_width, int grid_height, CUstream hStream);
 ...
 * \notefnerr
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuParamSetTexRef(CUfunction hfunc, int texunit, CUtexref hTexRef);
 ...
 * ::cuGraphClone
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphCreate(CUgraph *phGraph, unsigned int flags);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddKernelNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, const CUDA_KERNEL_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphKernelNodeSetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphKernelNodeGetParams(CUgraphNode hNode, CUDA_KERNEL_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphKernelNodeGetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphKernelNodeSetParams(CUgraphNode hNode, const CUDA_KERNEL_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddMemcpyNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, const CUDA_MEMCPY3D *copyParams, CUcontext ctx);
 ...
 * ::cuGraphMemcpyNodeSetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphMemcpyNodeGetParams(CUgraphNode hNode, CUDA_MEMCPY3D *nodeParams);
 ...
 * ::cuGraphMemcpyNodeGetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphMemcpyNodeSetParams(CUgraphNode hNode, const CUDA_MEMCPY3D *nodeParams);
 ...
 * ::cuGraphAddMemcpyNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddMemsetNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, const CUDA_MEMSET_NODE_PARAMS *memsetParams, CUcontext ctx);
 ...
 * ::cuGraphMemsetNodeSetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphMemsetNodeGetParams(CUgraphNode hNode, CUDA_MEMSET_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphMemsetNodeGetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphMemsetNodeSetParams(CUgraphNode hNode, const CUDA_MEMSET_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddHostNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, const CUDA_HOST_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphHostNodeSetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphHostNodeGetParams(CUgraphNode hNode, CUDA_HOST_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphHostNodeGetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphHostNodeSetParams(CUgraphNode hNode, const CUDA_HOST_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphClone
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddChildGraphNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, CUgraph childGraph);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphChildGraphNodeGetGraph(CUgraphNode hNode, CUgraph *phGraph);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddEmptyNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddEventRecordNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, CUevent event);
 ...
 * ::cuStreamWaitEvent
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphEventRecordNodeGetEvent(CUgraphNode hNode, CUevent *event_out);
 ...
 * ::cuStreamWaitEvent
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphEventRecordNodeSetEvent(CUgraphNode hNode, CUevent event);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddEventWaitNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, CUevent event);
 ...
 * ::cuStreamWaitEvent
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphEventWaitNodeGetEvent(CUgraphNode hNode, CUevent *event_out);
 ...
 * ::cuStreamWaitEvent
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphEventWaitNodeSetEvent(CUgraphNode hNode, CUevent event);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddExternalSemaphoresSignalNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, const CUDA_EXT_SEM_SIGNAL_NODE_PARAMS *nodeParams);
 ...
 * ::cuWaitExternalSemaphoresAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExternalSemaphoresSignalNodeGetParams(CUgraphNode hNode, CUDA_EXT_SEM_SIGNAL_NODE_PARAMS *params_out);
 ...
 * ::cuWaitExternalSemaphoresAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExternalSemaphoresSignalNodeSetParams(CUgraphNode hNode, const CUDA_EXT_SEM_SIGNAL_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddExternalSemaphoresWaitNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, const CUDA_EXT_SEM_WAIT_NODE_PARAMS *nodeParams);
 ...
 * ::cuWaitExternalSemaphoresAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExternalSemaphoresWaitNodeGetParams(CUgraphNode hNode, CUDA_EXT_SEM_WAIT_NODE_PARAMS *params_out);
 ...
 * ::cuWaitExternalSemaphoresAsync
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExternalSemaphoresWaitNodeSetParams(CUgraphNode hNode, const CUDA_EXT_SEM_WAIT_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddBatchMemOpNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, const CUDA_BATCH_MEM_OP_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphBatchMemOpNodeSetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphBatchMemOpNodeGetParams(CUgraphNode hNode, CUDA_BATCH_MEM_OP_NODE_PARAMS *nodeParams_out);
 ...
 * ::cuGraphBatchMemOpNodeGetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphBatchMemOpNodeSetParams(CUgraphNode hNode, const CUDA_BATCH_MEM_OP_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecBatchMemOpNodeSetParams(CUgraphExec hGraphExec, CUgraphNode hNode, const CUDA_BATCH_MEM_OP_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddMemAllocNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, CUDA_MEM_ALLOC_NODE_PARAMS *nodeParams);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphMemAllocNodeGetParams(CUgraphNode hNode, CUDA_MEM_ALLOC_NODE_PARAMS *params_out);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddMemFreeNode(CUgraphNode *phGraphNode, CUgraph hGraph, const CUgraphNode *dependencies, size_t numDependencies, CUdeviceptr dptr);
 ...
 * ::cuGraphMemAllocNodeGetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphMemFreeNodeGetParams(CUgraphNode hNode, CUdeviceptr *dptr_out);
 ...
 * ::cuDeviceGetGraphMemAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGraphMemTrim(CUdevice device);
 ...
 * ::cuGraphAddMemFreeNode
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetGraphMemAttribute(CUdevice device, CUgraphMem_attribute attr, void* value);
 ...
 * ::cuGraphAddMemFreeNode
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceSetGraphMemAttribute(CUdevice device, CUgraphMem_attribute attr, void* value);
 ...
 * ::cuGraphNodeFindInClone
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphClone(CUgraph *phGraphClone, CUgraph originalGraph);
 ...
 * ::cuGraphClone
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphNodeFindInClone(CUgraphNode *phNode, CUgraphNode hOriginalNode, CUgraph hClonedGraph);
 ...
 * ::cuGraphMemsetNodeSetParams
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphNodeGetType(CUgraphNode hNode, CUgraphNodeType *type);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphGetNodes(CUgraph hGraph, CUgraphNode *nodes, size_t *numNodes);
 ...
 * ::cuGraphNodeGetDependentNodes
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphGetRootNodes(CUgraph hGraph, CUgraphNode *rootNodes, size_t *numRootNodes);
 ...
 * ::cuGraphNodeGetDependentNodes
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphGetEdges(CUgraph hGraph, CUgraphNode *from, CUgraphNode *to, size_t *numEdges);
 ...
 * ::cuGraphRemoveDependencies
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphNodeGetDependencies(CUgraphNode hNode, CUgraphNode *dependencies, size_t *numDependencies);
 ...
 * ::cuGraphRemoveDependencies
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphNodeGetDependentNodes(CUgraphNode hNode, CUgraphNode *dependentNodes, size_t *numDependentNodes);
 ...
 * ::cuGraphNodeGetDependentNodes
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphAddDependencies(CUgraph hGraph, const CUgraphNode *from, const CUgraphNode *to, size_t numDependencies);
 ...
 * ::cuGraphNodeGetDependentNodes
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphRemoveDependencies(CUgraph hGraph, const CUgraphNode *from, const CUgraphNode *to, size_t numDependencies);
 ...
 * ::cuGraphAddMemsetNode
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphDestroyNode(CUgraphNode hNode);
 ...
 * ::cuGraphExecDestroy
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphInstantiate(CUgraphExec *phGraphExec, CUgraph hGraph, unsigned long long flags);
 ...
 * ::cuGraphExecDestroy
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphInstantiateWithParams(CUgraphExec *phGraphExec, CUgraph hGraph, CUDA_GRAPH_INSTANTIATE_PARAMS *instantiateParams);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecGetFlags(CUgraphExec hGraphExec, cuuint64_t *flags);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecKernelNodeSetParams(CUgraphExec hGraphExec, CUgraphNode hNode, const CUDA_KERNEL_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecMemcpyNodeSetParams(CUgraphExec hGraphExec, CUgraphNode hNode, const CUDA_MEMCPY3D *copyParams, CUcontext ctx);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecMemsetNodeSetParams(CUgraphExec hGraphExec, CUgraphNode hNode, const CUDA_MEMSET_NODE_PARAMS *memsetParams, CUcontext ctx);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecHostNodeSetParams(CUgraphExec hGraphExec, CUgraphNode hNode, const CUDA_HOST_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecChildGraphNodeSetParams(CUgraphExec hGraphExec, CUgraphNode hNode, CUgraph childGraph);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecEventRecordNodeSetEvent(CUgraphExec hGraphExec, CUgraphNode hNode, CUevent event);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecEventWaitNodeSetEvent(CUgraphExec hGraphExec, CUgraphNode hNode, CUevent event);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecExternalSemaphoresSignalNodeSetParams(CUgraphExec hGraphExec, CUgraphNode hNode, const CUDA_EXT_SEM_SIGNAL_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecExternalSemaphoresWaitNodeSetParams(CUgraphExec hGraphExec, CUgraphNode hNode, const CUDA_EXT_SEM_WAIT_NODE_PARAMS *nodeParams);
 ...
 * ::cuGraphLaunch
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphNodeSetEnabled(CUgraphExec hGraphExec, CUgraphNode hNode, unsigned int isEnabled);
 ...
 * ::cuGraphLaunch
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphNodeGetEnabled(CUgraphExec hGraphExec, CUgraphNode hNode, unsigned int *isEnabled);
 ...
 * ::cuGraphExecDestroy
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphUpload(CUgraphExec hGraphExec, CUstream hStream);
 ...
 * ::cuGraphExecDestroy
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphLaunch(CUgraphExec hGraphExec, CUstream hStream);
 ...
 * ::cuGraphLaunch
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecDestroy(CUgraphExec hGraphExec);
 ...
 * ::cuGraphCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphDestroy(CUgraph hGraph);
 ...
 * ::cuGraphInstantiate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphExecUpdate(CUgraphExec hGraphExec, CUgraph hGraph, CUgraphExecUpdateResultInfo *resultInfo);
 ...
 * ::CUaccessPolicyWindow
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphKernelNodeCopyAttributes(CUgraphNode dst, CUgraphNode src);
 ...
 * ::CUaccessPolicyWindow
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphKernelNodeGetAttribute(CUgraphNode hNode, CUkernelNodeAttrID attr,
 ...
 * ::CUaccessPolicyWindow
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphKernelNodeSetAttribute(CUgraphNode hNode, CUkernelNodeAttrID attr,
 ...
 * ::CUDA_ERROR_OPERATING_SYSTEM
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphDebugDotPrint(CUgraph hGraph, const char *path, unsigned int flags);
 ...
 * ::cuGraphCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuUserObjectCreate(CUuserObject *object_out, void *ptr, CUhostFn destroy,
 ...
 * ::cuGraphCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuUserObjectRetain(CUuserObject object, unsigned int count);
 ...
 * ::cuGraphCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuUserObjectRelease(CUuserObject object, unsigned int count);
 ...
 * ::cuGraphCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphRetainUserObject(CUgraph graph, CUuserObject object, unsigned int count, unsigned int flags);
 ...
 * ::cuGraphCreate
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphReleaseUserObject(CUgraph graph, CUuserObject object, unsigned int count);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuOccupancyMaxActiveBlocksPerMultiprocessor(int *numBlocks, CUfunction func, int blockSize, size_t dynamicSMemSize);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(int *numBlocks, CUfunction func, int blockSize, size_t dynamicSMemSize, unsigned int flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuOccupancyMaxPotentialBlockSize(int *minGridSize, int *blockSize, CUfunction func, CUoccupancyB2DSize blockSizeToDynamicSMemSize, size_t dynamicSMemSize, int blockSizeLimit);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuOccupancyMaxPotentialBlockSizeWithFlags(int *minGridSize, int *blockSize, CUfunction func, CUoccupancyB2DSize blockSizeToDynamicSMemSize, size_t dynamicSMemSize, int blockSizeLimit, unsigned int flags);
 ...
 * \notefnerr
 */
__declspec(dllexport) CUresult CUDAAPI cuOccupancyAvailableDynamicSMemPerBlock(size_t *dynamicSmemSize, CUfunction func, int numBlocks, int blockSize);
 ...
 * ::cuFuncGetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuOccupancyMaxPotentialClusterSize(int *clusterSize, CUfunction func, const CUlaunchConfig *config);
 ...
 * ::cuFuncGetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuOccupancyMaxActiveClusters(int *numClusters, CUfunction func, const CUlaunchConfig *config);
/** @} */ /* END CUDA_OCCUPANCY */
 ...
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetArray(CUtexref hTexRef, CUarray hArray, unsigned int Flags);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetMipmappedArray(CUtexref hTexRef, CUmipmappedArray hMipmappedArray, unsigned int Flags);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetAddress(size_t *ByteOffset, CUtexref hTexRef, CUdeviceptr dptr, size_t bytes);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetAddress2D(CUtexref hTexRef, const CUDA_ARRAY_DESCRIPTOR *desc, CUdeviceptr dptr, size_t Pitch);
 ...
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetFormat(CUtexref hTexRef, CUarray_format fmt, int NumPackedComponents);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetAddressMode(CUtexref hTexRef, int dim, CUaddress_mode am);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetFilterMode(CUtexref hTexRef, CUfilter_mode fm);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetMipmapFilterMode(CUtexref hTexRef, CUfilter_mode fm);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetMipmapLevelBias(CUtexref hTexRef, float bias);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetMipmapLevelClamp(CUtexref hTexRef, float minMipmapLevelClamp, float maxMipmapLevelClamp);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetMaxAnisotropy(CUtexref hTexRef, unsigned int maxAniso);
 ...
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetBorderColor(CUtexref hTexRef, float *pBorderColor);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefSetFlags(CUtexref hTexRef, unsigned int Flags);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetAddress(CUdeviceptr *pdptr, CUtexref hTexRef);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetArray(CUarray *phArray, CUtexref hTexRef);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetMipmappedArray(CUmipmappedArray *phMipmappedArray, CUtexref hTexRef);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetAddressMode(CUaddress_mode *pam, CUtexref hTexRef, int dim);
 ...
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetFilterMode(CUfilter_mode *pfm, CUtexref hTexRef);
 ...
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetFormat(CUarray_format *pFormat, int *pNumChannels, CUtexref hTexRef);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetMipmapFilterMode(CUfilter_mode *pfm, CUtexref hTexRef);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetMipmapLevelBias(float *pbias, CUtexref hTexRef);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetMipmapLevelClamp(float *pminMipmapLevelClamp, float *pmaxMipmapLevelClamp, CUtexref hTexRef);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetMaxAnisotropy(int *pmaxAniso, CUtexref hTexRef);
 ...
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetBorderColor(float *pBorderColor, CUtexref hTexRef);
 ...
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetFlags(unsigned int *pFlags, CUtexref hTexRef);
 ...
 * \sa ::cuTexRefDestroy
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefCreate(CUtexref *pTexRef);
 ...
 * \sa ::cuTexRefCreate
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuTexRefDestroy(CUtexref hTexRef);
 ...
 * ::cuSurfRefGetArray
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuSurfRefSetArray(CUsurfref hSurfRef, CUarray hArray, unsigned int Flags);
 ...
 */
__declspec(dllexport) __CUDA_DEPRECATED CUresult CUDAAPI cuSurfRefGetArray(CUarray *phArray, CUsurfref hSurfRef);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuTexObjectCreate(CUtexObject *pTexObject, const CUDA_RESOURCE_DESC *pResDesc, const CUDA_TEXTURE_DESC *pTexDesc, const CUDA_RESOURCE_VIEW_DESC *pResViewDesc);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuTexObjectDestroy(CUtexObject texObject);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuTexObjectGetResourceDesc(CUDA_RESOURCE_DESC *pResDesc, CUtexObject texObject);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuTexObjectGetTextureDesc(CUDA_TEXTURE_DESC *pTexDesc, CUtexObject texObject);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuTexObjectGetResourceViewDesc(CUDA_RESOURCE_VIEW_DESC *pResViewDesc, CUtexObject texObject);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuSurfObjectCreate(CUsurfObject *pSurfObject, const CUDA_RESOURCE_DESC *pResDesc);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuSurfObjectDestroy(CUsurfObject surfObject);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuSurfObjectGetResourceDesc(CUDA_RESOURCE_DESC *pResDesc, CUsurfObject surfObject);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuTensorMapEncodeTiled(CUtensorMap *tensorMap, CUtensorMapDataType tensorDataType, cuuint32_t tensorRank, void *globalAddress, const cuuint64_t *globalDim, const cuuint64_t *globalStrides, const cuuint32_t *boxDim, const cuuint32_t *elementStrides, CUtensorMapInterleave interleave, CUtensorMapSwizzle swizzle, CUtensorMapL2promotion l2Promotion, CUtensorMapFloatOOBfill oobFill);
 ...
 * ::cuTensorMapReplaceAddress
 */
__declspec(dllexport) CUresult CUDAAPI cuTensorMapEncodeIm2col(CUtensorMap *tensorMap, CUtensorMapDataType tensorDataType, cuuint32_t tensorRank, void *globalAddress, const cuuint64_t *globalDim, const cuuint64_t *globalStrides, const int *pixelBoxLowerCorner, const int *pixelBoxUpperCorner, cuuint32_t channelsPerPixel, cuuint32_t pixelsPerColumn, const cuuint32_t *elementStrides, CUtensorMapInterleave interleave, CUtensorMapSwizzle swizzle, CUtensorMapL2promotion l2Promotion, CUtensorMapFloatOOBfill oobFill);
 ...
 * ::cuTensorMapEncodeIm2col
 */
__declspec(dllexport) CUresult CUDAAPI cuTensorMapReplaceAddress(CUtensorMap *tensorMap, void *globalAddress);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceCanAccessPeer(int *canAccessPeer, CUdevice dev, CUdevice peerDev);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxEnablePeerAccess(CUcontext peerContext, unsigned int Flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuCtxDisablePeerAccess(CUcontext peerContext);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuDeviceGetP2PAttribute(int* value, CUdevice_P2PAttribute attrib, CUdevice srcDevice, CUdevice dstDevice);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphicsUnregisterResource(CUgraphicsResource resource);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphicsSubResourceGetMappedArray(CUarray *pArray, CUgraphicsResource resource, unsigned int arrayIndex, unsigned int mipLevel);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphicsResourceGetMappedMipmappedArray(CUmipmappedArray *pMipmappedArray, CUgraphicsResource resource);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphicsResourceGetMappedPointer(CUdeviceptr *pDevPtr, size_t *pSize, CUgraphicsResource resource);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphicsResourceSetMapFlags(CUgraphicsResource resource, unsigned int flags);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphicsMapResources(unsigned int count, CUgraphicsResource *resources, CUstream hStream);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGraphicsUnmapResources(unsigned int count, CUgraphicsResource *resources, CUstream hStream);
 ...
 */
__declspec(dllexport) CUresult CUDAAPI cuGetProcAddress(const char *symbol, void **pfn, int cudaVersion, cuuint64_t flags, CUdriverProcAddressQueryResult *symbolStatus);
 ...
 * ::cuCoredumpSetAttributeGlobal
 */
__declspec(dllexport) CUresult CUDAAPI cuCoredumpGetAttribute(CUcoredumpSettings attrib, void* value, size_t *size);
 ...
 * ::cuCoredumpSetAttributeGlobal
 */
__declspec(dllexport) CUresult CUDAAPI cuCoredumpGetAttributeGlobal(CUcoredumpSettings attrib, void *value, size_t *size);
 ...
 * ::cuCoredumpSetAttributeGlobal
 */
__declspec(dllexport) CUresult CUDAAPI cuCoredumpSetAttribute(CUcoredumpSettings attrib, void* value, size_t *size);
 ...
 * ::cuCoredumpSetAttribute
 */
__declspec(dllexport) CUresult CUDAAPI cuCoredumpSetAttributeGlobal(CUcoredumpSettings attrib, void *value, size_t *size);

/** @} */ /* END CUDA_COREDUMP */

__declspec(dllexport) CUresult CUDAAPI cuGetExportTable(const void **ppExportTable, const CUuuid *pExportTableId);
